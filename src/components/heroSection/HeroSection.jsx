      ...
      <div className='booking'>
        <div className='type'>
          <div className={ active === "bookNow" ? 'firstActive' : undefined } onClick={ () => setActive("bookNow") }>
            ...
            <img className="myDIV" src='question-mark.svg' alt='' style={ { cursor: "pointer", width: "17px", height: "17px", marginRight: "10px" } } />
          ...
          <div className={ active === "byHour" ? 'secondActive' : undefined } onClick={ () => setActive("byHour") }>
            ...
            <img className="myDIV" src='question-mark.svg' alt='' style={ { cursor: "pointer", width: "16px", height: "16px", marginRight: "10px" } } />
            ...
            <div className='details'>
              { active != "packages" &&
                <>
                  ...
                  <div className='box'>
                    <div className='input-dropdown'>
                      <img src='user.svg' style={ { width: "12px" } } /><span style={ { fontSize: "8px", marginTop: "2px" } }>العدد:</span>
                      <Select className='select-input'
